...
# This dictionary maps two-letter country codes to their full names.
# It's used to get the 'location' parameter for the SerpAPI call.
COUNTRY_CODE_MAP = {
    ...
    'lt': 'Lithuania', 'lu': 'Luxembourg', 'mo': 'Macao', 'mk': 'Macedonia, the Former Yugosalv Republic of',
    ...
    'tn': 'Tunisia', 'tr': 'Turkiye', 'tm': 'Turkmenistan', 'tc': 'Turks and Caicos Islands',
